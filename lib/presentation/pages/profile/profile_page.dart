...
class ProfilePage extends ConsumerWidget {
  ...
  Widget _buildAuthenticatedBody(BuildContext context, WidgetRef ref, User user) {
                    ...
                    child: CircleAvatar(
                      ...
                      child: CircleAvatar(
                        ...
                        child: user.avatar == null || user.avatar!.isEmpty
                            ? Icon(Icons.person_outline_rounded, size: 48, color: AppColors.grey.withOpacity(0.5))
                            : null,
                      ),
                    ),
                  ),
  ...
  Widget _buildProfileRow(IconData icon, String label, String value, {bool isLast = false}) {
    return Column(
      children: [
        ...
        if (!isLast)
          Divider(height: 1, indent: 58, endIndent: 20, color: Colors.black.withOpacity(0.04)),
      ],
    );
  }

  Widget _buildActionRow(IconData icon, String label, {bool isLast = false, required VoidCallback onTap}) {
    return Column(
      children: [
        InkWell(
          onTap: onTap,
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Icon(Icons.chevron_right_rounded, color: AppColors.grey.withOpacity(0.4), size: 20),
              ],
            ),
          ),
        ),
